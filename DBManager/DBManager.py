...
class DBManagerHhRu(BaseClassForDBManager):
    ...
    @classmethod
    def get_companies_and_vacancies_count(cls, cur) -> list[(), ()]:
        """
    ...
    @classmethod
    def get_all_vacancies(cls, cur) -> list[(), ()]:
        """
    ...
    @classmethod
    def get_avg_salary(cls, cur) -> list[(), ()]:
        """
    ...
    @classmethod
    def get_vacancies_with_higher_salary(cls, cur) -> list[(), ()]:
        """
    ...
    @classmethod
    def get_vacancies_with_keyword(cls, cur, word_for_search='') -> list[(), ()]:
        """
